...
# }
mat<-"split_matrix_Nitrogenfixer_Nonfixer_KO_matrix_raw.tsv"
...
tree<-read.tree("iqtrees_busco_650sample_834genes_rerooted.treefile")
...
mat<-"Hermaphroditic0Unisexual1_Phyloglm_25SpOG_rmStopCodenLongestProteins_PresenceAbsence.tsv"
Tab<-read.table(mat,header=T,sep="\t",row.names=1,check.names=F)

tree<-read.tree("D:/tengxinyue/project/Athaliana_Kegg/PhyloGLM/淡水海水/25Sp_2079OG_SupermatIqtree_rerooted.tre")
plot(tree)
